...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS, hyperspeedRef }) => {
  ...
  useEffect(() => {
    if (appRef.current) {
      ...
      appRef.current = null;
      if (hyperspeedRef) hyperspeedRef.current = null;
    ...
    if (hyperspeedRef) hyperspeedRef.current = myApp;
